...
#class ClassifyYOLO(nn.Module):
    """YOLOv9 adaptado para classificaÃƒÂ§ÃƒÂ£o de imagens"""
    #def __init__(self, nc=10, ch=3):
    #    super(ClassifyYOLO, self).__init__()
    #    self.nc = nc  # NÃƒÂºmero de classes

        # Backbone simplificado para classificaÃƒÂ§ÃƒÂ£o
   ...
   #         Conv(128, 256, 3, 2),
    #        Conv(256, 512, 3, 2)
     #   )
        ...
        # Camada de classificaÃƒÂ§ÃƒÂ£o
     #   self.classifier = nn.Sequential(
     #       nn.AdaptiveAvgPool2d(1),  # Reduz para (batch_size, 512, 1, 1)
     #       nn.Flatten(),  # Converte para (batch_size, 512)
     #       nn.Linear(512, self.nc)  # SaÃƒÂ­da com o nÃƒÂºmero de classes
     #   
    ...
    #def _initialize_weights(self):
        """ #Inicializa os pesos da rede para evitar problemas de camadas vazias. """
...
# Garantir que o modelo usado seja o correto para classificaÃƒÂ§ÃƒÂ£o
#Model = ClassifyYOLO